...
//      }
    ...
    "addFileList":function(fileList,opt){
        ...
        for(var i=0;i<fileList.length;i++){
        	//console.info($(".fileItem").length);
//          var num=$(".fileItem").length;
//      	 if(num==1){
            	//$(".fileItem").eq(0).remove();
...
//          }
            ...
            if(opt.rememberUpload){
             ...
             //判断文件是否存在
             //让我想想
            var aaa=uploadTools.fileIsExit(fileList[i],opt);
            console.info(aaa+"ooo");
